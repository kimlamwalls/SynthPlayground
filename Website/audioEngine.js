...
class AudioEngine {
    ...
    constructor(debug) {
        ...
        // Shoelace radio group for waveform selection
 /*       document.querySelector('sl-radio-group[name="waveform-group"]').addEventListener('sl-change', (event) => {
            audioEngine.oscillator.type = event.target.value;
